...
def validateOptions(options):
    ...
    validatePath(options, "jobtemplatefile", checkIsFile=True)
    validatePath(options, "shelltemplatefile", checkIsFile=True)
    validatePath(options, "runtimeconfigsourcefile", checkIsFile=True)
    ...
    validatePath(options, "templatedir", required=True, checkIsDir=True)
